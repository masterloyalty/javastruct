...
public abstract class StructInput extends InputStream {
    ...
    public void readField(StructFieldData fieldData, Method getter, Method setter, Object obj)
        ...
        if (!field.getType().isArray()) {
            switch (fieldData.getType()) {
                case BOOLEAN:
                    if (setter != null)
                        setter.invoke(obj, new Object[] {readBoolean()});
                    else
                ...
                case BYTE:
                    if (setter != null)
                        setter.invoke(obj, new Object[] {readByte()});
                    else
                ...
                case SHORT:
                    if (setter != null)
                        setter.invoke(obj, new Object[] {readShort()});
                    else
                ...
                case INT:
                    if (setter != null)
                        setter.invoke(obj, new Object[] {readInt()});
                    else
                ...
                case LONG:
                    if (setter != null)
                        setter.invoke(obj, new Object[] {readLong()});
                    else
                ...
                case CHAR:
                    if (setter != null)
                        setter.invoke(obj, new Object[] {readChar()});
                    else
                ...
                case FLOAT:
                    if (setter != null)
                        setter.invoke(obj, new Object[] {readFloat()});
                    else
                ...
                case DOUBLE:
                    if (setter != null)
                        setter.invoke(obj, new Object[] {readDouble()});
                    else
            ...
            switch (fieldData.getType()) {
                case BOOLEAN:
                    if (getter != null)
                        readBooleanArray((boolean[])getter.invoke(obj, (Object[])null));
                    else
                ...
                case BYTE:
                    if (getter != null)
                        readByteArray((byte[])getter.invoke(obj, (Object[])null));
                    else
                ...
                case CHAR:
                    if (getter != null)
                        readCharArray((char[])getter.invoke(obj, (Object[])null));
                    else
                ...
                case SHORT:
                    if (getter != null)
                        readShortArray((short[])getter.invoke(obj, (Object[])null));
                    else
                ...
                case INT:
                    if (getter != null)
                        readIntArray((int[])getter.invoke(obj, (Object[])null));
                    else
                ...
                case LONG:
                    if (getter != null)
                        readLongArray((long[])getter.invoke(obj, (Object[])null));
                    else
                ...
                case FLOAT:
                    if (getter != null)
                        readFloatArray((float[])getter.invoke(obj, (Object[])null));
                    else
                ...
                case DOUBLE:
                    if (getter != null)
                        readDoubleArray((double[])getter.invoke(obj, (Object[])null));
                    else
                ...
                default:
                    if (getter != null)
                        readObjectArray((Object[])getter.invoke(obj, (Object[])null));
                    else
    ...
    public void handleObject(Field field, Object obj)
        throws IllegalArgumentException, StructException, IOException, InstantiationException, IllegalAccessException {
