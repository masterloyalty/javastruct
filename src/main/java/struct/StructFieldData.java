...
public class StructFieldData {
    ...
    public StructFieldData(Field field, boolean requiresGetterSetter, Method getter, Method setter,
        Constants.Primitive type, boolean isArrayLenghtMarker, Field lengthDefinedArray) {
        super();
        this.field = field;
