...
/**
 * ACBHeader struct for Adobe Photoshop Color book (acb) files. For complete format information please look at:
...
public class ACBHeader {
    ...
    public ACBHeader(String title, short colorSpace, int colorCount, String colorNamePrefix, String colorNamePostfix,
        String description) {
